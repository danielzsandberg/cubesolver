...
namespace TotalMove
{
    public class BUPhasePTwo2 //: ICubeSolvingAlgorithm
    {
        public string AlgorithmName
        {
            get { return "BUPhasePTwo2"; }
        }
...
//BOTH FOLLOWING if's ARE CORRECTING ONES AND SHOULD BE ADDED TO THE ORIGINAL ZPhaseOne2
